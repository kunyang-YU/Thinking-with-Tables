...
deepspeed --master_port=29505 \
    ...
    --resume_from_checkpoint /data/yuky/rl_code_ckpt/v37-20260110-145636/checkpoint-240 \
    --use_vllm true \
    --vllm_mode server \
    ...
    --dataset \
        /ssd/yuky/TwT/data/RL_data/WTQdata/HiTab/train.json \
        /ssd/yuky/TwT/data/RL_data/WTQdata/FinQA/train.json \
        /ssd/yuky/TwT/data/RL_data/WTQdata/TAT-QA/train.json \
        /ssd/yuky/TwT/data/RL_data/MMData/paintings_train.json \
        /ssd/yuky/TwT/data/RL_data/MMData/pawpularity_train.json \
        /ssd/yuky/TwT/data/RL_data/MMData/skinca_train.json \
        /ssd/yuky/TwT/data/RL_data/MMData/adoption_train2.json \
